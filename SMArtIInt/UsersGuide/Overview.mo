...
<p>SMArtIInt Library comes along with some <a href=\"modelica://SMArtIInt.Tester\">Examples</a>. The python scripts which created the used TFLite models can be found <a href=\"modelica://SMArtIInt/../ExampleNeuralNets\">here</a>.</p>
</html>"));
end Overview;
